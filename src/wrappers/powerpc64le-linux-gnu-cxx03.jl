# Autogenerated wrapper script for SZ3_jll for powerpc64le-linux-gnu-cxx03
...
function __init__()
    JLLWrappers.@generate_init_header(CompilerSupportLibraries_jll, GSL_jll, Zstd_jll)
